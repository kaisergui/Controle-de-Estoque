 ...
 * @author 287792
 */
public class ExcluirFornecedor extends javax.swing.JFrame {

    private static ArrayList<Fornecedor> Fornecedors = new ArrayList<Fornecedor>();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Exclusão de Fornecedores");
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        if (posicao != -1) {
            codigo = Fornecedors.get(posicao).getFornecedor_id();
            jTextField4.setText(String.valueOf(Fornecedors.get(posicao).getFornecedor_id()));
            jTextField2.setText(String.valueOf(Fornecedors.get(posicao).getNome()));
            jTextField3.setText(String.valueOf(Fornecedors.get(posicao).getEmail()));
            jTextField5.setText(String.valueOf(Fornecedors.get(posicao).getTelefone()));
            jTextField6.setText(String.valueOf(Fornecedors.get(posicao).getEndereco()));
        }
    ...
    public static void carregaCombo() {
        try {
            ...
            Fornecedors = MDAO.listar();
        } catch (Exception ex) {
            System.out.println("problema");
        }

        for (int i = 0; i < Fornecedors.size(); i++) {
            jComboBox1.addItem(Fornecedors.get(i).getNome());
