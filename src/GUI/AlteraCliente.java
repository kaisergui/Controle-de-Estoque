...
public class AlteraCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Selecione o cliente para alterar:");
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        id = Clientes.get(posicao).getCliente_id();
        carrega();
    ...
    public void carrega() {
        ClienteDAO MDAO = new ClienteDAO();
        M = MDAO.procurar(id);
        String cliente_id = String.valueOf(M.getCliente_id());
        jTextField4.setText(cliente_id);
